                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">${tbContent.id == 0 ? "新增":"编辑"}内容</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form:form id="inputForm" cssClass="form-horizontal" action="/content/save" method="post" modelAttribute="tbContent">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <form:input path="categoryName" cssClass="form-control required email" placeholder="请选择" readonly="true" data-toggle="modal" data-target="#modal-default" value="${tbContent.tbContentCategory.name}" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:hidden path="content" class="form-control" placeholder="详情" />
                                        <div id="editor">
                                            ${tbContent.content}
                                        </div>
                                    </div>
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-default" onclick="history.go(-1);">Return</button>
