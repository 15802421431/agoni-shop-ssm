                        ...
                        <form:form id="inputForm" cssClass="form-horizontal" action="/content/category/save" method="post" modelAttribute="tbContentCategory">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input path="name" class="form-control required" placeholder="分类名称" value="${tbContentCategory.name}"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input path="sortOrder" class="form-control required digits" placeholder="分类排序" value="${tbContentCategory.sortOrder}"/>
                                    </div>
                                </div>
                            </div>
